...
//
//public class Write_A_Review_Pom extends WebDriverFactory {
//	private static final Logger logger = LogManager.getLogger(Write_A_Review_Pom.class);
//	Write_A_Review_Page write_A_Review_Page;
//
//	@Before
//	public void setUp(Scenario scn) throws Exception {
//		logger.info("=============== Write a review pom ================");
//		this.scn = scn;
...
//		write_A_Review_Page.Clk_Login_Link();
//		scn.log("Sign In page is opned");
//	}
//
...
//		scn.log("Entered valid login detail"+" : "+"email = " + email+" password = "+password);
//	}
//
